...
<body>
    ...
    if (isset($_SESSION['username'])) {
        ...
        if (isset($_POST['btn_coach'])) {
            $coach_name = $_POST['coach_name'];

            $insert = mysqli_query($conn, "INSERT INTO coach values ('', '$coach_name')");
            if ($insert) {
                ...
                <div class="card text-center" style="width: 400px;">
                    <div class="card-body">
                        ...
                        <form action="" method="post">
                            ...
                            <input type="text" name="coach_name" id="coach_name" class="form-control" required><br>
                            <button type="submit" name="btn_coach" class="btn btn-primary">Save</button>
                        </form>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>";
                                echo "<button class='delete-btn' data-id='" . $row['coach_id'] . "'>Remove</button>";
                                echo "</td>";
                                echo "</tr>";
                            }
                        } else {
